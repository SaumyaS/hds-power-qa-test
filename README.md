...
Then in a web browser, you can visit [mlocal.shop.hdsupplypowersolutions.com](http://mlocal.shop.hdsupplypowersolutions.com) and you are ready to start testing and developing!
...
If running `sudo moov server`, remember to put all domains you're going to hit in your etc/hosts if you run your server with the `-auto-hosts=false` option.
    ...
    127.0.0.1   mlocal.shop.hdsupplypowersolutions.com
